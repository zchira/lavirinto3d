...
public class TextureLoader {
	...
	public Texture getTexture(String resourceName) throws IOException {
		...
		tex = getTexture(resourceName, GL11.GL_TEXTURE_2D, // target
				...
				// GL11.GL_NEAREST_MIPMAP_LINEAR, // min filter (unused)
	...
	public void clearTexture(Texture t) {
		table.remove(t);
	}
	...
	public Texture getTexture(String resourceName, int target,
		...
		// GLU.gluBuild2DMipmaps(target, 3, get2Fold(bufferedImage.getWidth()),
	...
	public ByteBuffer getIconAsByteBuffer(String file) throws IOException {
		BufferedImage image = loadImage(file);
		
		ByteBuffer toReturn = convertImageData(image, null);
		return toReturn;
	}
}
