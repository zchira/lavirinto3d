...
public class BitmapFont {
	 ...
	 *            The width of the characters on the sheet (in pixels)
	 * @param characterHeight
	 *            The height of the characters on the sheet (in pixels)
	 */
	public BitmapFont(Texture texture, int characterWidth, int characterHeight) {
		...
		characterWidthInTexture = texture.getWidth()
				/ (texture.getImageWidth() / characterWidth);
		characterHeightInTexture = texture.getHeight()
				/ (texture.getImageHeight() / characterHeight);
		...
		characterStep = characterWidth - characterWidth / 2;
	 ...
	 * 
	 * @param font
	 *            The index of the font to draw. 0 means the font at the top, 1
	 *            the font at the bottom.
	 * @param text
	 *            The text to be draw to the screen.
	 * @param x
	 *            The x coordinate to draw the text at (int pixels)
	 * @param y
	 *            The y coordinate to draw the text at (in pixels)
	 */
